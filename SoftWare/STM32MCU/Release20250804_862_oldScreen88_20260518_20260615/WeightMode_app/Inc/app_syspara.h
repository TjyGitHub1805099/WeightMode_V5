...
typedef enum HX711SystemParaType
{
	...
	HX711SystemPara_EqualBanance = 23,		/**< 等重配平 0x1020*/
	HX711SystemPara_MenWomen = 24,		    /**< 男声女声 0x1021*/
	HX711SystemPara_PeiPingMode = 25,		/**< 配平模式 0x1022*/
...
//system parameter
typedef enum HX711PeiPingModeType
{
	enum_PeiPingMode_SuiJi = 0,			/**< 配平模式 : 随机配平 */
	enum_PeiPingMode_DuiCheng = 1		/**< 配平模式 : 对称配平 */
}enumHX711PeiPingModeType;
...
typedef struct SystemParaType
{
	...
	INT32	EqualBanance;	/**< 等重配平 0x1020*/
	INT32	MenWomen;	    /**< 男声女声 0x1021*/
	enumHX711PeiPingModeType	PeiPingMode;	/**< 配平模式 0x1022*/
	//sys used flag
