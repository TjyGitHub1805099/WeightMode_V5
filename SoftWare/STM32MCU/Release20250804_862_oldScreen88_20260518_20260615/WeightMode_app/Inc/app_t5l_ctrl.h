...
#define DMG_FUNC_DIWEN_BANACMOUD_ADDRESS		(0X1020)//0X1020 等重配平
#define DMG_FUNC_DIWEN_MENWOMEN_ADDRESS			(0X1021)//0X1021 男声女声
#define DMG_FUNC_DIWEN_PEIPING_ADDRESS			(0X1022)//0X1022 配平方式（对称配平还是随机配平）
...
typedef enum DMGPageType
{
	...
	//2头
	INNER_SCREEN_Balancing_2_2_HOME_PAGE = 64,//单台
	INNER_SCREEN_Balancing_4HS2_HOME_PAGE = 64,//级联 从机

	//6头
	INNER_SCREEN_Balancing_6_6_HOME_PAGE = 48,//单台
	INNER_SCREEN_Balancing_12HS6_HOME_PAGE = 63,//级联 从机

	//8头
	INNER_SCREEN_Balancing_H8_HOME_PAGE = 49,//单台
	...
	EXTERNAL_SCREEN_Balancing_6_HOME_PAGE = 3,
