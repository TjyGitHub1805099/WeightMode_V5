...
#define L8_WEIGHT_VLU_INDEX_DIS_XWSLX	(0x0100)//小数位数+变量类型
...
//帮助信息：不带小数点显示
appScreenDpCfg_Type ES_16H_HelpVlue_DP_Vlu_WuXiaoShu[18]=
{
//  	x坐标   y坐标   背景颜色    字库+字体大小	  对齐+整数位数    小数位数+变量类型
	{	35,		573,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	573,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	305,	573,	0xF810,		0x001A,			0x0204,			0x0000},
			
	{	35,		638,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	638,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	305,	638,	0xF810,		0x001A,			0x0204,			0x0000},
		
	{	35,		703,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	703,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	305,	703,	0xF810,		0x001A,			0x0204,			0x0000},
		
	{	465,	573,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	573,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	745,	573,	0xF810,		0x001A,			0x0204,			0x0000},
		
	{	465,	638,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	638,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	745,	638,	0xF810,		0x001A,			0x0204,			0x0000},
		
	{	465,	703,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	703,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	745,	703,	0xF810,		0x001A,			0x0204,			0x0000},
};

//帮助信息：带小数点显示 
appScreenDpCfg_Type ES_16H_HelpVlue_DP_Vlu_YouXiaoShu[18]=
{
//  	x坐标   y坐标   背景颜色    字库+字体大小	  对齐+整数位数    小数位数+变量类型
	{	35,		573,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	573,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	300,	580,	0xF810,		0x0014,			0x0204,			0x0100},
			
	{	35,		638,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	638,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	300,	645,	0xF810,		0x0014,			0x0204,			0x0100},
		
	{	35,		703,	0x0000,		0x001A,			0x0202,			0x0000},
	{	155,	703,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	300,	710,	0xF810,		0x0014,			0x0204,			0x0100},
		
	{	465,	573,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	573,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	730,	580,	0xF810,		0x0014,			0x0204,			0x0100},
		
	{	465,	638,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	638,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	730,	645,	0xF810,		0x0014,			0x0204,			0x0100},
		
	{	465,	703,	0x0000,		0x001A,			0x0202,			0x0000},
	{	585,	703,	0x00FF,		0x001A,			0x0202,			0x0000},
	{	730,	710,	0xF810,		0x0014,			0x0204,			0x0100},
};
