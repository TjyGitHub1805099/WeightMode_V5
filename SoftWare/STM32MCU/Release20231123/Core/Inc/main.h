...
#define USART2_TX_SCREEN2_RX_Pin GPIO_PIN_5
#define USART2_TX_SCREEN2_RX_GPIO_Port GPIOD
#define USART2_RX_SCREEN2_TX_Pin GPIO_PIN_6
#define USART2_RX_SCREEN2_TX_GPIO_Port GPIOD
