...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = USART2_TX_SCREEN2_RX_Pin|USART2_RX_SCREEN2_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = USART6_TX_WX_RX_Pin|USART6_RX_WX_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, USART2_TX_SCREEN2_RX_Pin|USART2_RX_SCREEN2_TX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, USART6_TX_WX_RX_Pin|USART6_RX_WX_TX_Pin);
